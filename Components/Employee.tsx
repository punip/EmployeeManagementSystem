            ...
            <div className='card-body'>
                <form>
                    <div className='form-group mb-2'>
                        ...
                        <input type="text" value={firstName} placeholder="Enter the First Name" onChange={(e) => setFirstName(e.target.value)}></input>
                        {errors.firstName && <div style={{color:'red'}}> {errors.firstName} </div>}
                        
                    <div />
                    <div className='form-group mb-2'>
                            <label className='form-label'>Last Name:</label>
                            <input type="text" value={lastName} placeholder="Enter the Last Name" onChange={(e) => setLastName(e.target.value)}></input>
                            {errors.lastName && <div style={{color:'red'}}> {errors.lastName} </div>}
                    <div />
                    <div className='form-group mb-2'>
                                <label className='form-label'>Email:</label>
                                <input type="text" value={email} placeholder="Enter the Email" onChange={(e) => setEmail(e.target.value)}></input>
